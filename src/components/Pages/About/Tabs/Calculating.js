        ...
        <section>
            <h2 id="calculatinggenomeproperties">Calculating Genome Properties</h2>
                ...
                <p>
                    ...
                    PERL5LIB=$PERL5LIB:/code/modules). It is then possible to run <code>assign_genome_properties.pl</code>
                    using the TSV file as the input, and specifying the required output (outfiles) format.
                </p>
