            ...
            <div className="top-block">
                <div id="gp-controllers" className="top-controllers">
                    <div>
                        ...
                        <ul>
                            <li><label htmlFor="tax-search">From Taxonomy:</label>
                    ...
                    <div>
                        ...
                        <ul>
                            <li><label htmlFor="gp-selector">By Top level category:</label>
                                <div id="gp-selector" className="selector"></div>
                            </li>
                            <li><label htmlFor="gp-filter">by Text:</label>
                    ...
                    <div>
                        ...
                        <ul>
                            <li><label htmlFor="tax_label">Species:</label>
                                <select id="tax_label">
                            ...
                            <li><label htmlFor="gp_label">Properties:</label>
                                <select id="gp_label">
